...
Original file is located at
    https://colab.research.google.com/drive/1V_qBVGwodge-3G0a736DVIGEmxjSI08S
...
pct_ganados = np.array([0.688, 0.688, 0.563, 0.25, 0.125, 0.688, 0.625,
                        0.438, 0.313, 0.688, 0.625, 0.5, 0.438, 0.125,
                        0.813, 0.688, 0.563, 0.375, 0.25, 0.688, 0.563,
                        0.313, 0.313, 0.313, 0.875, 0.75, 0.375, 0.375])

num_clases = 5
clases = np.linspace(pct_ganados.min(), pct_ganados.max(), num_clases + 1)

frecuencias_abs, _ = np.histogram(pct_ganados, bins=clases)
frecuencias_rel = frecuencias_abs / len(pct_ganados)

centros_clases = (clases[:-1] + clases[1:]) / 2
plt.figure(figsize=(8,5))
plt.plot(centros_clases, frecuencias_abs, marker='o', linestyle='-', color='b', label='Frecuencia Absoluta')
...
frecuencias_acum = np.cumsum(frecuencias_abs[::-1])[::-1]
plt.figure(figsize=(8,5))
plt.plot(centros_clases, frecuencias_acum, marker='o', linestyle='-', color='r', label='Frecuencia Acumulada')
plt.xlabel('Porcentaje de juegos ganados')
plt.ylabel('Frecuencia Acumulada')
...
print("Clases:", clases)
print("Frecuencia Absoluta:", frecuencias_abs)
print("Frecuencia Relativa:", frecuencias_rel)
